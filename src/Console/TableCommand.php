...
class TableCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'bank-statements:table';
     ...
     * @var string
     */
    protected $description = 'Create a migration for the bank statements database table';
     ...
     * @return string
     */
    protected function createBaseMigration($table = 'bank_statements')
    {
    ...
    protected function replaceMigration($path, $table, $tableClassName)
    {
        $stub = str_replace(
            ...
            [$table, $tableClassName],
            $this->files->get(__DIR__.'/stubs/statements.stub')
        );
